export module node.instruction.memory.push;
...
namespace node::instruction::memory {
  export class Push : public Memory {
  private:
  ...
  public:
    ...
    Push(const lexical::source::Span& span, node::Declaration* target, node::Declaration* value) noexcept;
