...
namespace node::declaration::literal::structured {
  ...
  Function::Function(const lexical::source::Span& span, node::Scope& scope, node::scope::context::Function& function_scope, std::vector<node::Declaration*>&& parameters, std::vector<node::Declaration*>&& captures, bool is_arrow) noexcept
  ...
  node::Declaration* Function::Value() const { return nullptr; }
