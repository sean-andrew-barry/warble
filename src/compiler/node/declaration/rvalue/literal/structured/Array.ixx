export module node.declaration.rvalue.literal.structured.array;
...
namespace node::declaration::rvalue::literal::structured {
  ...
  export class Array : public Structured {
  private:
    std::vector<std::shared_ptr<node::Declaration>> values;
  public:
    using Structured::Structured;

    Array(const lexical::source::Span& span, node::Scope& scope);
    Array(const lexical::source::Span& span, node::Scope& scope, std::vector<std::shared_ptr<node::Declaration>>&& values);
