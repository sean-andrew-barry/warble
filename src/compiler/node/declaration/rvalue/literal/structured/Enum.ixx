export module node.declaration.rvalue.literal.structured._enum;
...
namespace node::declaration::rvalue::literal::structured {
  ...
  public:
    ...
    Enum(const lexical::source::Span& span, node::Scope& scope, std::vector<std::shared_ptr<node::Declaration>>&& values);
