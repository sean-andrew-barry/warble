...
namespace compiler::input {
  ...
  //     case ir::Token::ExponentOperator: return ir::Opcode::Exponent;
  ...
  //     instructions[join_index].SetOperand(0, end); // Patch jump to the end of the else-if chain
  //     return end;
  //   }
  ...
  //     instructions[join_index].SetOperand(0, end); // Patch jump to the end of the else-if chain
  //   } else {
  //     instructions[join_index].SetOperand(0, exit); // Patch jump to the exit label
  //   }
